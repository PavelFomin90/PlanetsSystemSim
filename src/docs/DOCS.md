...
- `PlanetsListPanel` — панель списка всех планет в системе с возможностью поиска и сортировки.
- `PlanetInfoModal` — модальное окно с детальной информацией о планете.
...
### UI
- Клик по планете в панели списка — фокусировка на планете и отображение детальной информации
- Поиск по имени в панели списка планет
- Сортировка списка планет по имени, массе и расстоянию до центра
...
│   │       ├── BasePanel/ # базовый класс для панелей
│   │       ├── PlanetsListPanel/ # панель списка планет
│   │       │   ├── PlanetsListPanel.ts
│   │       │   ├── PlanetInfoModal.ts
│   │       │   └── PlanetsListPanel.css
│   │       └── InfoPanel/ # панель информации о планете
│   └── utils/           # вспомогательные функции
│       ├── math.ts
│       └── throttle.ts
